...
l[1]="    ${cyan}╭────────────────────────────────────────────────────────╮"
l[2]="    ${cyan}│                                                        │"
l[3]="    ${cyan}│${reset}             	 ${bold}${cyan}wizard_alfredo${reset}         	     ${cyan}│"
l[4]="    ${cyan}│${reset}	       ${bold}Junior Content Engineer @ HackTheBox${reset}          ${cyan}│"
l[5]="    ${cyan}│${reset}	       ${cyan}────────────────────────────────────${reset}	     ${cyan}│"
l[6]="    ${cyan}│                                                        │"
l[7]="    ${cyan}│${reset}     ${underline}${bold}HTB:${reset}  ${bg_black}${green}https://app.hackthebox.com/profile/201215${reset}    ${cyan}│"
l[8]="    ${cyan}│${reset}     ${underline}${bold}CTF Team:${reset}  ${red}https://th3os.com/                      ${cyan}│"
l[9]="    ${cyan}│${reset}     ${underline}${bold}GitHub:${reset}  ${dim}https://github.com/WizardAlfredo${reset}          ${cyan}│"
l[10]="    ${cyan}│${reset}     ${underline}${bold}Email:${reset}  ${magenta}wizardalfredo@hackthebox.com               ${cyan}│"
l[11]="    ${cyan}│                                                        │"
l[12]="    ${cyan}│${reset}     ${underline}${bold}Card:${reset}  ${yellow}curl -sL https://bit.ly/3z2gH67 | sh        ${cyan}│"
l[13]="    ${cyan}│                                                        │"
l[14]="    ${cyan}╰────────────────────────────────────────────────────────╯"
